...
module  pc_verilog (
    ...
    localparam PC_JMPNZ = 4'h5;
    localparam PC_JMPNN = 4'h7;
            ...
            if (pc_enable) begin
                if ((pc_op_select == `PC_RAM_OP) || (pc_op_select == `PC_ROM_OP)) begin
                    ...
                    case(pc_op_operation)
                        ...
                        PC_JMPNZ: pc_register <= (flags[0] == 1'b0) ? jump_val : pc_register + 1'b1;
                        PC_JMPNN: pc_register <= (flags[2] == 1'b0) ? jump_val : pc_register + 1'b1; // Jump if positive (not negative)
