...
for i = 1:len
    ...
    while dial_val + 0 < 0
        ...
        % If we're in one of these cases, we're crossing over 0 (for part 2)
        zero_count = zero_count + 1; % Uncomment for part 2, comment out for part 1
    end
